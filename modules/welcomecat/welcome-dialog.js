...
module.exports = class WelcomeDialog {
  ...
  createRoutes(app, dialogId) {
    app.post('/welcome-cat', async (req, res) => {
      ...
      let welcomeObject = await this.welcomeHelper.getOptionsForChannel(
        channel_id
      );
      ...
      this.context.showDialog(
        {
          ...
          elements: [
            ...
            },
            {
              ...
              type: 'select',
              value:
                welcomeObject && welcomeObject.get('enabled')
                  ? 'true'
                  : 'false',
              name: 'enabled',
              options: [
            ...
            },
            {
              ...
              type: 'select',
              value:
                welcomeObject && welcomeObject.get('generic_welcome')
                  ? 'true'
                  : 'false',
              name: 'welcome_select',
              options: [
